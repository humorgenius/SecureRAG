      ...
      blocks: [
        ...
        { t: 'h2', text: 'What this site is, and what it is not' },
        {
          ...
          rows: [
            ...
            ['How it is funded', 'Google AdSense on a limited set of pages, loaded personalized only after you agree'],
      ...
      blocks: [
        ...
        { t: 'h2', text: '这个站点是什么，不是什么' },
        {
          ...
          rows: [
            ...
            ['靠什么维持', '只有限的若干页面上放 Google AdSense，个性化广告只在你同意后加载，其他地区拒绝后仍展示非个性化广告'],
