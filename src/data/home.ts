...
export const home: Record<Lang, HomeContent> = {
  en: {
    ...
    trust: {
      eyebrow: 'Privacy',
      heading: 'Your files never leave your computer',
      title: 'Plain words, and how to check them',
      tag: 'Checkable in 30 seconds',
      points: [
        {
          num: '01',
          title: 'There is no upload step at all',
          body: 'When you pick a file the browser opens it for us straight from your disk, into memory. There is no upload step in the code and no place a file could be sent to, so this is not a promise about how we behave, it is a property of the program.',
        },
        {
          num: '02',
          title: 'Nothing trains on your files',
          body: 'The tool only ever asks the model to read, never to learn: no training step, no feedback loop, and no copy left anywhere outside your own browser.',
        },
        {
          num: '03',
          title: 'One outside connection, and you can watch it',
          body: 'The only external request is the one-time model download. It carries the model file name and nothing else: no document, no question, no identifier. Open the network panel and watch it happen.',
        },
        {
          num: '04',
          title: 'Deleting really deletes',
          body: 'Clear this site\'s data in your browser and every chunk, index and conversation goes with it. There is no copy on our side to delete, because there never was one.',
        },
      ],
    },
    compare: {
      ...
      points: [
        {
          num: '01',
          title: '文件根本不会被上传',
          body: '你选的文件由浏览器自己打开、直接读进内存。我们的代码里没有“上传”这一步，也没有任何能接收文件的地方——这不是承诺，是这个程序就没有那个功能。',
        },
        {
          num: '02',
          title: '没人拿你的文件训练模型',
          body: '这个工具只让模型“读”，不让它“学”：没有训练过程、没有反馈回路，也不会在你浏览器之外留下任何副本。',
        },
        {
          num: '03',
          title: '只连了一个外部地址',
          body: '唯一的外部请求是第一次下载模型文件。那个请求里只有模型文件名，没有你的文档、没有你的提问，也没有任何能认出你的标识。',
        },
        {
          num: '04',
          title: '删掉就是真删掉',
          body: '在浏览器里清除本站数据，所有文本、索引和问答记录都会一起消失。我们这边没有副本可删，因为从来没拿到过。',
        },
      ],
    },
    compare: {
