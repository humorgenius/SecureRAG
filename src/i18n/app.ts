...
export const appStrings = {
  en: {
    ...
    'match.title': 'All matches — {n} sentence(s)',
    'match.files': 'in {n} file(s)',
    'match.show': 'Show every match',
    'match.hide': 'Hide the list',
  ...
  zh: {
    ...
    'chat.sources': '来源',
    'match.title': '全部匹配处 · {n} 句',
    'match.files': '来自 {n} 份文件',
    'match.show': '展开全部匹配处',
    'match.hide': '收起列表',
