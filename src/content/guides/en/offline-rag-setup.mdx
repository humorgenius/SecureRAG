...
steps:
  ...
  - title: "Request persistent storage"
    text: "Let the tool ask for persistent storage while it sets itself up, or run navigator.storage.persist() in the console yourself. The browser then treats this origin as less likely to be evicted."
